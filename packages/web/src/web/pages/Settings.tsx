    ...
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <section className="space-y-3">
        ...
        <details className="rounded-[16px] bg-rd-surface p-4" style={{ boxShadow: 'var(--rd-shadow-card)' }}>
          ...
          <div className="mt-3 space-y-3">
            ...
            <p className="text-[13px] leading-relaxed text-rd-label-secondary">
              ...
              completes, nothing is saved to camera roll/disk/cloud, and OCR runs entirely on-device.
            </p>
          </div>
        </details>
        ...
        <div className="rounded-[16px] p-4 space-y-3" style={{ background: 'rgba(255,59,48,0.08)' }}>
          ...
          <p className="text-[13px] text-rd-label-secondary">All data is stored locally in your browser. Clearing browser data will delete everything.</p>
